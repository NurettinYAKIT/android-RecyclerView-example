...
public class ItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (extras != null) {
                    String value = extras.getString(ItemDetailFragment.ARG_ITEM_ID);
                    //The key argument here must match that used in the other activity
                    item = StockModel.getItem(value);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            // This ID represents the Home ssor Up button. In the case of this
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, CartListActivity.class));
            return true;
        }
